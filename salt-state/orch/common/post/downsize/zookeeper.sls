...
{{role_target}} post downsize orchestrate create config:
...
{{role_target}} post downsize orchestrate restart service:
  salt.function:
    - name: cmd.run
    - tgt: {{ target }}
    - arg:
...
{{role_target}} post downsize orchestrate check service:
  salt.function:
    - name: cmd.run
    - tgt: {{ target }}
    - arg:
