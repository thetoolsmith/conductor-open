...
post startup common orchestration state hook message:
  salt.function:
    - name: cmd.run
    - tgt: 'saltmaster'
    - arg:
      - echo test post startup common orchestrate state, nodes {{minion_target}}

post startup common orchestration state hook:
